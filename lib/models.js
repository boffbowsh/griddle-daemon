...
module.exports = function(redis) {
  ...
  models.App.prototype = {
    ...
    load: function(cb) {
      var self = this;
      redis.get("griddle:apps:" + this.name + ":slug", function(err, res) {
        self.slug = res;
        cb();
      });
    }
  ...
  models.Formation.prototype = {
    load: function(cb) {
      var self = this;
      redis.hgetall("griddle:apps:"+this._appName+":formation", function(err, res) {
        if (res) {
          Object.keys(res).forEach(function(key) {
    ...
    save: function(cb) {
      var key = "griddle:apps:"+this._appName+":formation";
      var multi = redis.multi().del(key);
      if (Object.keys(this).length > 0) {
        multi.hmset(key, this);
      }
