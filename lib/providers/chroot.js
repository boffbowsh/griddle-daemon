...
module.exports = {
  ...
  listProcesses: function(appName) {
    var processes = Object.keys(runningProcesses).map(function(el) {
      return {
        processId:   el,
        appName:     runningProcesses[el].appName,
        processType: runningProcesses[el].processType,
        slugId:      runningProcesses[el].slugId
      };
    });
